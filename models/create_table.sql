...
CREATE TABLE `user`(
    ...
    `update_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE_TIME,
    PRIMARY KEY (`id`),
...
INSERT INTO `community` VALUES('2','2','Leetcode','刷题刷题','2020-01-01 08:00:00','2020-01-01 08:00:00');
